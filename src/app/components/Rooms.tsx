...
export function Rooms({ rooms, onBookRoom, onAddRoom }: RoomsProps) {
  ...
  return (
    <div className="space-y-8">
      ...
      >
        <h1 className="mb-3 bg-gradient-to-r from-primary to-purple-600 bg-clip-text text-transparent">
          Our Rooms
        </h1>
          ...
          {filteredRooms.map((room, index) => (
            <AnimatedCard key={room.id} delay={index * 0.1}>
              <GlassCard className="overflow-hidden hover:shadow-2xl transition-all duration-300 group">
                <motion.div
                  className={`bg-gradient-to-br ${getGradient(index)} p-16 text-center relative overflow-hidden`}
                  whileHover={{ scale: 1.05 }}
                >
                  <motion.div
                    className="text-7xl"
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="pt-4 border-t border-border flex items-center justify-between">
                    <div>
                      ...
                      <motion.p
                        className="text-2xl font-semibold bg-gradient-to-r from-primary to-purple-600 bg-clip-text text-transparent"
                    ...
                    <motion.button
                      ...
                      className="bg-gradient-to-r from-primary to-purple-600 text-primary-foreground px-6 py-3 rounded-xl shadow-lg relative overflow-hidden group"
