...
export function BookingForm({ selectedRoom, onBack }: BookingFormProps) {
      ...
      >
        <GlassCard className="p-8 text-center space-y-6">
          ...
          >
            <GlassCard className="p-6 space-y-3 bg-gradient-to-br from-primary/5 to-purple-500/5">
              ...
              <div className="flex justify-between pt-3 border-t border-border">
                <span>Total</span>
                <span className="text-xl font-semibold text-primary">${totalPrice + Math.round(totalPrice * 0.1)}</span>
              </div>
            </GlassCard>
          </motion.div>
          ...
          <motion.button
            ...
            className="bg-gradient-to-r from-primary to-purple-600 text-primary-foreground px-8 py-3 rounded-xl shadow-lg"
  ...
  return (
    ...
    >
      <motion.button
        onClick={onBack}
        className="mb-6 flex items-center gap-2 text-primary hover:gap-3 transition-all"
        whileHover={{ x: -5 }}
      >
        ...
        <div className="lg:col-span-2">
          <GlassCard className="p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <motion.button
                type="submit"
                className="w-full bg-gradient-to-r from-primary to-purple-600 text-primary-foreground py-4 rounded-xl shadow-lg relative overflow-hidden group"
