...
import { Calendar, Users, DollarSign, Bed, Plus, Trash2, Edit as EditIcon } from 'lucide-react';
...
export function Admin({ rooms, bookings, onAddRoom, onDeleteRoom }: AdminProps) {
  const [activeTab, setActiveTab] = useState<'dashboard' | 'bookings' | 'rooms'>('rooms');
        ...
        <div className="flex gap-2 bg-muted/50 backdrop-blur-lg rounded-xl p-1">
          {['dashboard', 'bookings', 'rooms'].map((tab) => (
            <motion.button
              ...
              className={`relative px-4 py-2 rounded-lg capitalize transition-colors ${
                activeTab === tab ? '' : 'hover:bg-background/50'
              }`}
            ...
            >
              {activeTab === tab && (
                <motion.div
                  layoutId="activeTab"
                  className="absolute inset-0 bg-background shadow-lg rounded-lg"
            ...
            {bookings.length === 0 && rooms.length === 0 ? (
              <GlassCard className="p-12 text-center">
                ...
                <p className="text-muted-foreground">
                  Add rooms and start accepting bookings to see your dashboard stats.
                </p>
              </GlassCard>
            ) : (
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <GlassCard className="p-6">
                  <h3 className="mb-4">Room Overview</h3>
                  {rooms.length === 0 ? (
                    <div className="text-center py-8">
          ...
          >
            <div className="flex justify-end">
              <motion.button
                ...
                className="bg-gradient-to-r from-primary to-purple-600 text-primary-foreground px-6 py-3 rounded-xl shadow-lg flex items-center gap-2"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
                  ...
                  <GlassCard className="p-6">
                    ...
                    <div className="flex gap-3 mt-4">
                      <motion.button
                        ...
                        className="flex-1 bg-gradient-to-r from-primary to-purple-600 text-primary-foreground py-3 rounded-lg"
            ...
            {rooms.length === 0 ? (
              <GlassCard className="p-12 text-center">
                ...
                <h3 className="mb-2">No Rooms Yet</h3>
                <p className="text-muted-foreground">
                  Click the "Add New Room" button above to create your first room.
                </p>
              </GlassCard>
            ) : (
                  ...
                  >
                    <GlassCard className="p-6 group hover:shadow-xl transition-all">
                      ...
                      <div className="grid grid-cols-3 gap-4 mb-4">
                        ...
                        <div>
                          <p className="text-2xl font-semibold">{room.beds}</p>
